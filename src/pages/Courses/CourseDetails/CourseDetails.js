...
const CourseDetails = () => {
    ...
    const StarRating = ({ ratings }) => {
        ...
        const starsArray = Array.from({ length: 5 }, (_, index) => (
            <FaStar key={index} className={index < numStars ? "text-warning" : "text-secondary"} />
        ));
        return <>{starsArray}</>;
    };
                                        ...
                                        <div className="d-flex flex-column">
                                            <div>
                                                <ul className="border-top list-unstyled d-flex flex-column">
                                                    ...
                                                    <li className='border-bottom py-2 d-flex justify-content-between align-items-center'>
                                                        <div>
                                                            <MdVideoLibrary className='text-success' />
                                                    ...
                                                    <li className='border-bottom py-2 d-flex justify-content-between align-items-center'>
                                                        <div>
                                                            <SiLevelsdotfyi className='text-success' />
                                                    ...
                                                    <li className='border-bottom py-2 d-flex justify-content-between align-items-center'>
                                                        <div>
                                                            <FaLanguage className='text-success' />
                                            ...
                                            <div className='text-center'>
                                                <Button variant="success" className="btn-hover-dark">Enroll Now</Button>
                                            </div>
                                        </div>
